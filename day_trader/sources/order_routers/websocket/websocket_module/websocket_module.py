...
class WebSocketModule(BaseCommunicationModule, ICommunicationModule):
    ...
    def DoSendOrder(self, newOrder):
        ...
        try:
            ...
            self.DoLog("<order_router> Sending new Order with ClOrdId {} Qty=={} Price={}".format(newOrder.ClOrdId,newOrder.OrderQty,newOrder.Price), MessageType.INFO)
            ...
            self.DoLog("DBX= Converter price={}".format(orderReqDto.Price),MessageType.INFO)
