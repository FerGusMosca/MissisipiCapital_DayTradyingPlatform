...
class RoutePositionReq(WebSocketMessage):
    ...
    def __init__(self, Msg,Side,ReqId,Qty, Type=None,Account=None,Symbol=None,PosId=None,Price=None,
                 StopLoss=None,TakeProfit=None,CloseEndOfDay=None,UUID=None):
        ...
        self.CloseEndOfDay=CloseEndOfDay
        self.UUID = UUID
        self.ReqId = ReqId
        self.Qty = Qty
